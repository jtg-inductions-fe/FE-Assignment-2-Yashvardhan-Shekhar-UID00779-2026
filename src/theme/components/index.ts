    ...
    MuiCssBaseline: {
        styleOverrides: `
            ...
            @font-face {
                ...
                font-display: swap;
                font-weight: 400;
                src: url('${inter400Woff2}') format('woff2'), url('${inter400Woff}') format('woff');
            }
            ...
            @font-face {
                ...
                font-display: swap;
                font-weight: 500;
                src: url('${inter500Woff2}') format('woff2'), url('${inter500Woff}') format('woff');
            }
            ...
            @font-face {
                ...
                font-display: swap;
                font-weight: 600;
                src: url('${inter600Woff2}') format('woff2'), url('${inter600Woff}') format('woff');
            }
            ...
            @font-face {
                ...
                font-display: swap;
                font-weight: 700;
                src: url('${inter700Woff2}') format('woff2'), url('${inter700Woff}') format('woff');
            }
        `,
    },
};
